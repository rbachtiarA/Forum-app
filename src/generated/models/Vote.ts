...
export type VoteWhereInput = {
  ...
  voteScore?: Prisma.IntFilter<"Vote"> | number
...
export type VoteScalarWhereWithAggregatesInput = {
  ...
  voteScore?: Prisma.IntWithAggregatesFilter<"Vote"> | number
}

export type VoteCreateInput = {
  voteScore: number
  post: Prisma.PostCreateNestedOneWithoutVotesInput
  user: Prisma.ProfileCreateNestedOneWithoutVotesInput
}
...
export type VoteUpdateInput = {
  ...
  user?: Prisma.ProfileUpdateOneRequiredWithoutVotesNestedInput
}
...
export type VoteOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"postId" | "userId" | "voteScore", ExtArgs["result"]["vote"]>
...
export interface VoteDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const voteWithPostIdOnly = await prisma.vote.findMany({ select: { postId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Votes and only return the `postId`
   * const voteWithPostIdOnly = await prisma.vote.createManyAndReturn({
   *   select: { postId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Votes and only return the `postId`
   * const voteWithPostIdOnly = await prisma.vote.updateManyAndReturn({
   *   select: { postId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface VoteFieldRefs {
  ...
  readonly voteScore: Prisma.FieldRef<"Vote", 'Int'>
}
